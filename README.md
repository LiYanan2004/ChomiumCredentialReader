...
> [!CAUTION]
> The data structure may change based on which chromium version you're using.
> 
> This project is used for **educational-purpose only**.

### Data structure

Check this gist to view the lastest version.

- [chrome-encrypted-cookies.md](https://gist.github.com/creachadair/937179894a24571ce9860e2475a2d2ec)
